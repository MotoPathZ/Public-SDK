...
namespace MPZ.Service
{
    public static class NewsController
    {
        ...
        public static async Task<List<MPZNews>> IndexAsync()
        {
            ...
            string link = Tools.Networking.GetLink(Endpoints.Servers.API_SERVER, Endpoints.Type.News);
        ...
        public static async Task<MPZNews> ShowAsync(uint id)
        {
            ...
            string link = Tools.Networking.GetLink(Endpoints.Servers.API_SERVER, Endpoints.Type.News, id.ToString());
